...
const Mobile = () => {
    ...
    return (
        <div className="container-main mobile">
            ...
            <div className='sign_content mobile'>
                <h4 className="page-title mobile">Can we get your number</h4>
            ...
            <div className="d-grid">
                <button className="btn btn-continue mobile" onClick={handleOtpContinue}>Get OTP</button>
            </div>
            <ToastContainer />
        </div>
    );
